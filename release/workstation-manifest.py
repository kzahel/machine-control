#!/usr/bin/env python3
"""Authenticate an exact Windows workstation preview build, not an update feed."""
...
SCHEMA = "machine-control-workstation-manifest/v0"
PACKAGES = {
    "win-arm64": "machine-control-workstation-win-arm64.zip",
    "win-x64": "machine-control-workstation-win-x64.zip",
}
...
def verify(directory, revision, run, public_key=PUBLIC_KEY):
    ...
    if (value.get("schema") != SCHEMA
            or value.get("purpose") != "workstation-preview"
    ...
    print("Verified both Windows packages and their signed build identity")

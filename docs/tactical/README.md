...
| [`008-macos-ordinary-session-resident-control.md`](008-macos-ordinary-session-resident-control.md) | active | Tart-based macOS resident facade, native/Cua comparison, guest-local input, real system/application workflows, and stopped appliance acceptance |

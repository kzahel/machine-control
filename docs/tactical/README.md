...
| [`031-ios-adb-parity-operations.md`](031-ios-adb-parity-operations.md) | complete | Adaptive physical-iOS diagnostics: development-app inventory, direct URL payloads, transactional app logs, and bounded container exchange, with noisy process inventory and unsafe uninstall deferred |

...
| [`007-windows-iso-factory-acceptance.md`](007-windows-iso-factory-acceptance.md) | active | Live official unactivated Windows ARM64 ISO-to-appliance acceptance through unattended Setup, resident bootstrap, product installation, and cleanup |

...
| [`006-windows-safety-launch-efficiency-and-image-factory.md`](006-windows-safety-launch-efficiency-and-image-factory.md) | active | Fail-closed target identity, native packaged-app launch, compact semantics, expanded application evidence, and a generalized-image factory |

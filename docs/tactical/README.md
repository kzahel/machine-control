...
| [`035-native-signing-smoke.md`](035-native-signing-smoke.md) | active | Main-only native CI fixtures, publisher signing/notarization, and a verified three-platform manifest without release publication |

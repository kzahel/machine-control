...
| [`012-linux-gnome-wayland-resident-control.md`](012-linux-gnome-wayland-resident-control.md) | active | Guarded Ubuntu GNOME Wayland resident semantics, capture, input, system-surface, provider, and reboot acceptance |

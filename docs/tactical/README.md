...
| [`023-chromeos-common-readiness-and-maintenance.md`](023-chromeos-common-readiness-and-maintenance.md) | active | Common ChromeOS doctor plus partial runtime audit/repair and current-boot SSH persistence proof |

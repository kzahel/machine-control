...
| [`010-macos-full-aqua-software-testing.md`](010-macos-full-aqua-software-testing.md) | active | Complete logged-in Tart software-testing control through target-native semantics, visual fallback, privacy prompts, system dialogs, and administration with outer UI prohibited |

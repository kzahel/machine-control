...
| [`009-macos-administrator-sheet-control.md`](009-macos-administrator-sheet-control.md) | active | Target-resident control of normal macOS administrator sheets with a one-shot non-echoing credential channel and independent effects |

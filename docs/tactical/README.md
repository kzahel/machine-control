...
| [`027-windows-claimed-direct-transport.md`](027-windows-claimed-direct-transport.md) | active | Single-validation direct Windows administration and resident transport under an exclusive target-use claim |

...
| [`036-windows-workstation-distribution.md`](036-windows-workstation-distribution.md) | in progress | Ordinary-user Windows package with explicit privilege boundaries and appliance/CLI compatibility |

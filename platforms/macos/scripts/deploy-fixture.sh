...
source_file="$MACVM_REPO_DIR/guests/macos/fixture/MachineControlFixture.swift"
info_file="$MACVM_REPO_DIR/guests/macos/fixture/Info.plist"
...
remote_binary="$remote_contents/MacOS/MachineControlFixture"
...
macvm_exec /usr/bin/codesign --force --deep --sign - \
    --identifier org.machine-control.fixture "$remote_app"
macvm_exec \

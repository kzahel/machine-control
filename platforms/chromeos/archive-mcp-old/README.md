...
ssh chromeos-testbed "mkdir -p /mnt/stateful_partition/c2"

# Copy client.py
scp client.py chromeos-testbed:/mnt/stateful_partition/c2/
```
...
```bash
# Test ping
echo '{"cmd": "ping"}' | ssh chromeos-testbed "LD_LIBRARY_PATH=/usr/local/lib64 python3 /mnt/stateful_partition/c2/client.py"
# Should return: {"pong": true}

# Test info
echo '{"cmd": "info"}' | ssh chromeos-testbed "LD_LIBRARY_PATH=/usr/local/lib64 python3 /mnt/stateful_partition/c2/client.py"
